<?php
    ...
    class CAMQPQueue extends AMQPQueue
    {
        ...
        {
            Yii::trace(
                "Execute with params: " . TraceTextHelper::printData(func_get_args()),
                "CEXT.CAMQP.CAMQPQueue.ack"
            );

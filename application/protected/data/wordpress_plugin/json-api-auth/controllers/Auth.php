...
class JSON_API_Auth_Controller
{
    ...
    public function validate_auth_cookie()
    {
        ...
        if (!$json_api->query->cookie) {
            $json_api->error(
                "You must include a 'cookie' authentication cookie. Use the `create_auth_cookie` Auth API method."
            );
        }
    ...
    public function get_currentuserinfo()
    {
        ...
        if (!$json_api->query->cookie) {
            $json_api->error(
                "You must include a 'cookie' var in your request. Use the `generate_auth_cookie` Auth API method."
            );
        }
